...
ALTER SEQUENCE listindividualname_listindividual_seq RESTART WITH 2000000;
...
ALTER SEQUENCE edge_id_seq START WITH 10000;
ALTER SEQUENCE vertexname_vertex_seq START WITH 10000;
ALTER SEQUENCE accountName_account_seq START WITH 1000;
ALTER SEQUENCE ledgerName_ledger_seq START WITH 1000;
ALTER SEQUENCE journalName_journal_seq START WITH 1000;
ALTER SEQUENCE bookName_book_seq START WITH 1000;
ALTER SEQUENCE accountname_account_seq START WITH 1000;
ALTER SEQUENCE jobname_job_seq START WITH 1000;
ALTER SEQUENCE schedulename_schedule_seq START WITH 1000;
ALTER SEQUENCE entry_id_seq START WITH 1;
ALTER SEQUENCE journalentry_id_seq START WITH 1000;
ALTER SEQUENCE jobindividual_id_seq START WITH 1000;
ALTER SEQUENCE bill_id_seq START WITH 1000;
ALTER SEQUENCE cargo_id_seq START WITH 1000;
